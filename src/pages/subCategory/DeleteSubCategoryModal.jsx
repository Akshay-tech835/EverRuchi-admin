// src/pages/subcategories/DeleteSubCategoryModal.jsx
import React from "react";

export default function DeleteSubCategoryModal({ subCategory, onClose, onDelete }) {
    ...
    >
      ...
      >
        ...
        <p className="text-center text-gray-700 mb-6">
          ...
          <span className="font-bold">{subCategory.categoryId}</span>?
        </p>
